<section class="py-5 bg-light">
      <div class="container">
        <div class="col-12 col-lg-8 col-xxl-7 text-center mx-auto mb-5">
          ...
          <p class="lead text-muted mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque massa
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="p-3 p-md-5 bg-light rounded text-center">
              ...
              <ul class="mb-5">
                <li class="d-flex align-items-center mb-3">
                  <svg class="text-muted me-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24"
          ...
          <div class="col-12 col-md-8 col-xl-4 mb-5 mb-xl-0">
            <div class="p-3 p-md-5 bg-primary rounded text-center">
              ...
              <ul class="mb-5">
                <li class="d-flex align-items-center mb-3">
                  <svg class="text-info me-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24"
                    stroke="currentColor" style="width: 24px;height: 24px">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
